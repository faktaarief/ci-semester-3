...
--
-- Host: localhost:3306
-- Generation Time: Nov 25, 2019 at 11:19 PM
...
INSERT INTO `genre_music` (`kd_genre`, `genre`) VALUES
(1, 'Pop Indo'),
(2, 'Mood'),
(3, 'Focus'),
(4, 'Dangdut');
...
INSERT INTO `lagu` (`kd_lagu`, `judul_lagu`, `kd_genre`) VALUES
(1, 'Barbar', 1);
...
--
DELIMITER $$
CREATE TRIGGER `INSERT kd_user` AFTER INSERT ON `users` FOR EACH ROW INSERT INTO
status_users
SET
kd_user = NEW.kd_user
$$
...
--
ALTER TABLE `lagu`
  MODIFY `kd_lagu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
