...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2019 at 07:47 PM
...
(1, 'fakta', 'faktaarief99@gmail.com', '1a6fb3e0d81c89c0a796e6b9ef1fee49', 'L', '20-11-2019', 1),
...
--
ALTER TABLE `genre_music`
  MODIFY `kd_genre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `lagu`
--
ALTER TABLE `lagu`
  MODIFY `kd_lagu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
